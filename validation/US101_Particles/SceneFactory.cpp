...
void SceneFactory::build(Scene& scene) const {
    ...
    go.addComponent<ParticleSystem>(R"(..\..\..\validation\US101_Particles\res\smoke.png)", 20,5, Vector2(20,20),Vector2(0,0), 0);
    go.getComponent<ParticleSystem>().setSpread({200,240});
