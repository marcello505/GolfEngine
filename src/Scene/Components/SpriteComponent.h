...
namespace GolfEngine::Scene::Components {
    ...
    public:
        ...
        explicit SpriteComponent(const std::string &path, Vector2 pixelScale = Vector2(1, 1),
                                 Rect2 imageSource = Rect2(), Vector2 offsetPosition = Vector2(),
                                 float startingRotation = 0, Vector2 pivotPoint = Vector2(), Color color = Color());
