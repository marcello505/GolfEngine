...
namespace GolfEngine::Scene::Render {
    ...
    public:
        ...
        explicit SpriteRenderShape(std::string path, Vector2 position = Vector2(), float rotation = 0,
                                   Vector2 pixelScale = Vector2(1, 1), Rect2 imageSource = Rect2(),
                                   Vector2 pivotPoint = Vector2(), Color color = Color(255, 255, 255));
